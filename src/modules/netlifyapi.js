...
export async function callCarQueryProtected() {
  ...
  const fullPrompt = `In two or fewer sentences, tell me what vehicle I should buy based on this description: ${trimmedCarQuery}`;
  
  // Show spinner immediately before starting async work
